...
public class PDFWRITERActivity extends AppCompatActivity {
    Button clicks;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_pdfwriteractivity);
        clicks = findViewById(R.id.clickme);
        ...
        clicks.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Toast.makeText(PDFWRITERActivity.this, "You just Captured a Screenshot," +
